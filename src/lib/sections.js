 ...
 *
 * Deliberately no realm switcher here. Choosing a realm happens in ONE place —
 * the Admin Panel — and that choice then filters the whole session. Scattering
 * the switch across every page invites changing realm by accident while working
 * in another one.
 */
